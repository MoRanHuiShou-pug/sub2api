...
const (
	...
	// FieldSessionCookie holds the string denoting the session_cookie field in the database.
	FieldSessionCookie = "session_cookie"
	...
	FieldHealth = "health"
	// FieldHealthMsg holds the string denoting the health_msg field in the database.
	FieldHealthMsg = "health_msg"
...
// BySessionCookie orders the results by the session_cookie field.
func BySessionCookie(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSessionCookie, opts...).ToFunc()
}
...
// ByHealthMsg orders the results by the health_msg field.
func ByHealthMsg(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldHealthMsg, opts...).ToFunc()
}
