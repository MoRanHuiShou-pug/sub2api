...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamSessionService := service.NewUpstreamSessionService(accountRepository)
	upstreamSyncWorker := service.ProvideUpstreamSyncWorker(upstreamSessionService)
	upstreamSessionHandler := admin.NewUpstreamSessionHandler(upstreamSessionService)
