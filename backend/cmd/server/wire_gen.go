...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamRepository := repository.NewUpstreamRepository(client)
	upstreamSessionService := service.NewUpstreamSessionService(upstreamRepository)
	adminService := service.NewAdminService(userRepository, adminGroupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService, compositeModelRouteRepository, compositeRouteResolver, upstreamRepository, upstreamSessionService)
	...
	upstreamSyncWorker := service.ProvideUpstreamSyncWorker(upstreamRepository, upstreamSessionService)
	upstreamSessionHandler := admin.NewUpstreamSessionHandler(upstreamRepository, upstreamSessionService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamSessionHandler, upstreamBillingProbeService, ollamaCloudUsageService)
