...
const (
	...
	PlatformSub2api     = "sub2api" // Sub2API 上游实例
	PlatformNewapi      = "newapi"  // NewAPI 上游实例
)
...
const (
	...
	AccountTypeUpstreamSession  = "upstream_session"  // 上游会话类型账号（通过 email/password 登录 Sub2API/NewAPI，维护 JWT session）
)
